...
procedure getVariantes(words:TStrings;lemmas:TStrings;variante:TFDTable;variantes:TStrings;paises:String;varpaises:TFDTable;Clength:TStrings);
...
procedure getUsos(variante:String;pais:String;varpaises:TFDTable;usos:TStrings);
...
begin
  ...
  varpaises.Filter:='Clave_Variante='+variante+' and Clave_Pais='+QuotedStr(pais);
